...
from lib.tasks.markup_generation import _generate_html_for_range, TopicRange, MARKUP_ANCHOR_CORRECTION_TEMPLATE
...
class TestMarkupGenerationRetryLogic(unittest.TestCase):
    def test_generate_html_for_range_retry_includes_context(self):
        ...
        with patch('lib.tasks.markup_generation._call_llm_cached') as mock_cached:
            ...
            self.assertIn("Your previous response could not be parsed", full_correction_prompt)
