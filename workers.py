# Generated by CodeSpeak from spec file: workers.cs.md
...
def main():
    ...
    result = db.task_queue.delete_many({"status": "completed", "completed_at": {"$lt": cutoff}})
    logger.info(f"Removed {result.deleted_count} completed task(s) older than 2 days")
