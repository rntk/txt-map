...
describe("SummarySourceMenu", () => {
  it("renders matches and calls onSelect with the chosen topic", () => {
    ...
    fireEvent.click(
      screen.getByRole("menuitem", { name: /Science > Physics/i }),
    );
    ...
    expect(screen.getByRole("menu").getAttribute("style")).toContain(
      "--summary-source-menu-left: 40px",
    );
    expect(screen.getByRole("menu").getAttribute("style")).toContain(
      "--summary-source-menu-top: 50px",
    );
