...
describe('TreemapChart component', () => {
  ...
  it('renders the level selector and default subtitle', () => {
    ...
    expect(screen.getByText('Showing all topics at relative level 0 (Main Topics). Rectangle size reflects sentence count.')).toBeInTheDocument();
  });
  ...
  it('updates the subtitle when the selected level changes', () => {
    ...
    expect(screen.getByText('Showing all topics at relative level 1 (Subtopics). Rectangle size reflects sentence count.')).toBeInTheDocument();
  });
