...
export default function MarkupRenderer({ segments, sentences }) {
  ...
  const segmentsWithStart = segmentList
    .map((segment) => ({
      segment,
    ...
    <>
      {renderedSegments.map((segment, i) => {
        switch (segment.type) {
          case "dialog":
            return (
              <DialogMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "comparison":
            return (
              <ComparisonMarkup
          ...
          case "list":
            return (
              <ListMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "data_trend":
            return (
              <DataTrendMarkup
          ...
          case "timeline":
            return (
              <TimelineMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "definition":
            return (
              <DefinitionMarkup
          ...
          case "quote":
            return (
              <QuoteMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "code":
            return (
              <CodeMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "emphasis":
            return (
              <EmphasisMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "paragraph":
            return (
              <ParagraphMarkup
          ...
          case "title":
            return (
              <TitleMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "steps":
            return (
              <StepsMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "table":
            return (
              <TableMarkup key={i} segment={segment} sentences={sentences} />
            );
          ...
          case "callout":
            return (
              <CalloutMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "key_value":
            return (
              <KeyValueMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "summary":
            return (
              <SummaryMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "pro_con":
            return (
              <ProConMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "aside":
            return (
              <AsideMarkup key={i} segment={segment} sentences={sentences} />
            );
          case "rating":
            return (
              <RatingMarkup key={i} segment={segment} sentences={sentences} />
            );
          ...
          default:
            return (
              <PlainMarkup key={i} segment={segment} sentences={sentences} />
            );
        }
      })}
    </>
