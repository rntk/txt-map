  ...
  return (
    <>
      {safeGroups.map((group) => {
        const safeSentences = Array.isArray(group.sentences)
          ? group.sentences
          : [];
        ...
        return (
          ...
          >
            <div className="global-topic-group-header global-topics-source-card__header">
              <span className="global-topic-name-badge global-topics-source-card__topic">
                {group.topic_name}
              </span>
            ...
            <div className="global-topic-group-sentences global-topics-source-card__sentences">
              {safeSentences.map((sentence, j) => (
                <div
                  key={j}
                  className="global-topic-sentence global-topics-source-card__sentence"
                >
                  {sentence}
                </div>
              ))}
