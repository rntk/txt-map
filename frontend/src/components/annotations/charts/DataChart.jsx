...
export default function DataChart({ extraction, width, height }) {
  ...
  switch (chartType) {
    case 'bar':
      return <DataBarChart extraction={extraction} width={width} height={height} />;
    case 'line':
      return <DataLineChart extraction={extraction} width={width} height={height} />;
    case 'timeline':
    case 'gantt':
      return <DataTimelineChart extraction={extraction} width={width} height={height} />;
    default:
      return null;
  }
}
